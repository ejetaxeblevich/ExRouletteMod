...
function ER_CalcRandomPodskazka()
	...
	local strVal = ""
	if randomShell==1 then strVal = "FIRST" end
	if randomShell==2 then strVal = "SECOND" end
	if randomShell==3 then strVal = "THIRD" end
	if randomShell==4 then strVal = "FOURTH" end
	if randomShell==5 then strVal = "FIFTH" end
	if randomShell==6 then strVal = "SIXTH" end
	if randomShell==7 then strVal = "SEVENTH" end
	if randomShell==8 then strVal = "EIGHTH" end
